...
const FIELDS: Array<{ key: keyof Settings; label: string; type?: string; hint?: string; options?: string[] }> = [
  ...
  { key: 'pageTransition', label: 'Page turn (page mode)', options: ['fade', 'slide', 'blink', 'none'], hint: 'fade: old page dims, new page ramps up to full brightness (default) · slide: two in-between frames · blink: blank frame first · none: instant' },
